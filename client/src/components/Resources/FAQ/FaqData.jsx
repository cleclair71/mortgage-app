const faqData = [
    {
      ...
      answer: `To get an idea of how much you can afford, you'll need to know your taxable income, along with any outstanding debts and monthly payments.
      ...
      Use our handy [Mortgage Affordability Calculator](INSERT LINK) for help with your numbers.`,
    },
    {
      question: 'What is a home inspection and should I have one done?',
      answer: `In a word, yes. A home inspection is a visual examination of the property to determine the overall condition of the home. It should be done by a professional home inspector.
    ...
    {
      question: 'What is the minimum down payment needed to purchase a home?',
      answer: `A minimum down payment of 5% is required to purchase a home, subject to certain maximum price restrictions. Other situations, such as being self-employed or having poor credit, may also impact the required down payment amount.
      ...
      Mortgages with less than 20% down must have mortgage loan insurance provided by either [CMHC](INSERT CMHC LINK), [Sagen](INSERT SAGEN LINK), or [Canada Guaranty](INSERT CANADA GUARANTY LINK).`,
    },
    {
      question: 'What is mortgage loan insurance?',
      answer: `Mortgage loan insurance is legally required on mortgages with a Loan-to-Value (LTV) ratio greater than 80% (often called a high-ratio mortgage). It protects lenders against the risk of mortgage default and foreclosure by the borrower.
      ...
      In Canada, mortgage default insurance is provided by three companies: [Canada Mortgage and Housing Corporation (CMHC)](INSERT CMHC LINK), [Sagen](INSERT SAGEN LINK), and [Canada Guaranty](INSERT CANADA GUARANTY LINK). CMHC is a Crown corporation, while the other two are approved private corporations.`,
    },
    {
        question: 'What is a conventional mortgage?',
        answer: `A conventional mortgage is usually one where the down payment is equal to 20% or more of the purchase price, with a Loan-to-Value (LTV) of 80% or less. It typically does not require mortgage default insurance, and so the borrower does not have to pay these insurance premiums. Mortgage interest rates may be slightly higher, however, for lenders to offset the lack of default insurance.
        Read More: [Why a Bigger Down Payment Can Result in a Higher Rate](INSERT LINK)`,
      },
      {
        question: 'How does bankruptcy affect qualification for a mortgage?',
        answer: `After bankruptcy, it can be a challenge to re-establish your credit in securing a funded mortgage. However, depending on the circumstances surrounding your bankruptcy, some lenders may consider providing mortgage financing. Contact one of our friendly, expert brokers for more details.
        Read More: [How Bankruptcy Can Affect a New Mortgage](INSERT LINK)`,
      },
      {
        question: 'How will child support affect your mortgage qualification?',
        answer: `For child support and alimony paid by you to another person, this amount is typically deducted from your total income before determining the size of mortgage you can qualify for.
      ...
      },
      {
        ...
        answer: `Yes, subject to qualification. With current historically-low rates, even purchasers with 5% down may qualify to buy a home and make improvements to it ([get pre-qualified here](INSERT LINK)). Any down payment under 20% will need mortgage default insurance obtained through CMHC, Sagen or Canada Guaranty.
        ...
        If you're buying a home that needs renovations right off the start, a Purchase Plus Improvements mortgage can include these upgrade costs along with the home price (some conditions will apply). This option eliminates the need to finance the home and renovations separately.`,
      },
      {
        question: 'Can I use gift funds as a down payment?',
        answer: `Most lenders will accept down payment funds that are a gift from family. A gift letter signed by the donor is usually required to confirm that the funds are a true gift and not a loan. If mortgage default insurance is needed (with a down payment less than 20%), the lender or insurance provider may require the gift money to be in the purchaser's possession before the application is sent to them for approval.`,
      },
      {
        question: 'What is a pre-approved mortgage?',
        answer: `A pre-approved mortgage is a solid idea of the maximum amount of mortgage that you qualify for, along with an interest rate guarantee from a lender for a specified period of time (usually 60 to 120 days). It's usually one of the first steps a home buyer should take when looking for a home or property.
        ...
        Read More: [Pre-Qualify for a Mortgage in Minutes](INSERT LINK)`,
      },
      {
        question: 'How early can I renew my mortgage?',
        answer: `You can start your mortgage renewal process as early as 120 days (4 months) before the end of your current term, even if you haven't yet received your renewal offer. Lenders are only legally required to send your renewal statement at least 21 days before the deadline. Starting earlier provides more time to negotiate or look around for a better rate or mortgage fit.
      ...
      },
      {
        ...
        answer: `Very few Canadian homebuyers have the cash available to buy a property outright. Most of us will turn to a financial institution for a mortgage, which can be the first step in a potentially long-standing mortgage relationship. But even with a mortgage, you'll first need to raise money for a down payment.
      ...
      {
        question: 'Can I buy a home with as little as 5% down?',
        answer: `Yes, it's possible to buy a home or property in Canada with a minimum of 5% down (subject to maximum price restrictions). Lenders are now able to offer this type of mortgage funding thanks to mortgage loan (default) insurance.
      ...
      },
      {
        ...
        Read More: [Pre-Payment Penalties and Privileges](INSERT LINK)`,
      },
      {
        question: 'How can I use RRSPs to help buy my first home?',
        ...
        Read More: [First-Time Home Buyer Incentive](INSERT LINK)`,
      },
      {
        question: 'What are the costs associated with buying a home?',
        answer: `There are several costs that you'll be responsible for when buying a home or property. Here's a quick list for reference:
      ...
      },
      {
        ...
        answer: `The length of a mortgage term can vary from six months up to 10 years. The term you choose will depend on your current financial situation, your short and long-term goals, your tolerance for risk, and even a choice between a variable vs. fixed rate.
      ...
      },
      {
        ...
        answer: `Owning your own home can be a very rewarding personal and financial venture. But, it also comes with ongoing expenses, including maintenance and upgrade costs. Preparing ahead and continually budgeting will help you plan and pay for them as they come up.
      ...
      },
      {
        ...
        answer: `A fixed-rate mortgage is a type of mortgage where the interest rate is set for a pre-determined term, usually between 6 months to 10 years. A fixed-rate mortgage offers the security of knowing what you will be paying for the term selected.
        
        Read More: [How Government Bond Yields Relate To Mortgage Rates](INSERT LINK)`,
      },
      {
        question: 'What is a variable-rate mortgage?',
        answer: `A variable-rate mortgage is a type of mortgage where the interest rate is tied to the prime lending rate and will increase or decrease along with it.
        
        If prime goes up, so does your payment — or if your payment is static, then more of your payment will go towards interest costs and less down on the principal. If prime goes down, your payment will also go down, or more will be put towards the principal and less for interest.`,
      },
      {
        question: 'Can you have more than one high ratio mortgage?',
        answer: `A high ratio mortgage is one where your down payment at the time of purchase is less than 20%. In all such cases, the mortgage is insured by CMHC, Sagen, or Canada Guaranty.
      ...
      {
        question: 'Is a 25-year amortization better than a 30-year amortization?',
        answer: `The answer depends on your situation. If you can totally afford a 25-year amortization, then it would be considered "better," as you would pay off your mortgage in less time and pay much less interest over time.
      ...
      {
        question: 'If I buy a plot of land, will I qualify for a mortgage?',
      ...
      {
        question: 'Will I qualify for a mortgage with 20% down payment after I pay off my consumer proposal?',
        answer: `A mortgage to purchase a home may be doable once you start to generate scores from your new credit cards. There are a lot of factors, and location is HUGE because you will be talking with B-lenders and they are very picky where they lend.
      ...
      {
        question: 'Will my mortgage be approved if I am on probation at work?',
        answer: `It really depends on your overall profile. If the new job is in the same industry you have been in for years and if it is for more money, you have a good chance of being approved. And if you are in a high-demand industry like I.T., healthcare, education, that helps too. Multiple recent job changes or a new industry is more challenging. Do please ask us BEFORE you firm up an offer to purchase.`,
      },
      {
        question: 'Can we use an old appraisal report for our mortgage refinance?',
        answer: `Appraisals have to be very recent and not stale-dated and in rising markets, this is also in your best interests as your property has gone up markedly in value since the last time one was done.
      ...
      {
        question: 'Should I choose a fixed-rate or variable-rate mortgage?',
        answer: `For many years, those who chose a variable-rate mortgage have fared better than those who chose a fixed rate. Interest rates fell year after year, and the VRM acolytes saved lots of money compared to their friends.
      ...
      {
        question: 'What is an assignment of rents?',
        answer: `This is part of your mortgage loan agreement, which entitles the lender to any income (from leases, rents, etc.) derived from the property once the owner defaults on the loan.
        
        So it is a big deal only if you stop making mortgage payments and is reasonable for the lender to require. It is a fairly standard clause on all private and B-mortgages.`,
      },
      {
        question: 'What if the appraisal comes in low?',
        answer: `We are often asked what will happen if the appraisal comes in lower. Will the home buyer still be able to finance it?
      ...
      {
        question: 'Is the condo status certificate important for mortgage financing?',
        answer: `Our client wrote me and said, "I am intending to put in an offer on this unit. I had a lawyer review the status certificate. The status certificate package did not include the most recent audited financials. Will this impact on my ability to get financing? The lawyer indicated I should bring this to your attention."
      ...
      {
        question: 'What are the advantages and disadvantages of bi-weekly mortgage payments?',
        answer: `Many borrowers choose bi-weekly perhaps because they read somewhere that is the best repayment strategy — fully believing this will pay the whole she-bang off faster and with much less interest over time.
      ...
      {
        question: 'What if my GDSR and TDSR are a few percent over the limit?',
        answer: `Is it possible that I could get a pre-approval and eventually a mortgage in spite of this?
      ...
      {
        question: 'Will my maternity leave hurt our mortgage approval?',
        answer: `Not usually a problem. If you can produce a letter from your employer providing a return to work date with your position and expected compensation at that time, then it is as if you are still working. This is just as true for dads taking paternity leave.`,
      },
      {
        question: 'Can I get a mortgage to pay my CRA debt?',
        answer: `Chances are your bank will say no, you cannot. However, we have dozens of lenders who will readily pay this debt with mortgage financing. It might be a brand new first mortgage or maybe a temporary private second mortgage. No problem!`,
      },
      {
        question: 'What are your fees when you refinance a mortgage?',
        answer: `Fees associated with a mortgage refinance vary considerably, depending on your unique circumstances.
        ...
        - Appraisal costs: An appraisal costs from a few hundred dollars to well over $1,000. The cost depends on location, value, and urgency a rush job will cost more.`,
      },
      {
        question: 'How much does a mortgage broker cost?',
        answer: `There should be no cost if your mortgage is with a bank or some other A-lender. Brokerage fees are typically charged on private mortgages and B-lender mortgages. The amount depends on the size of the loan and the complexity of the client's situation. We are always clear and upfront about any such costs no surprises!`,
      },
      {
        question: 'Why is our high-ratio mortgage advance less than expected?',
        answer: `The likely primary reason is that you need to pay 8% PST on the mortgage insurance premium.
      ...
      {
        question: 'When will I need a bridge mortgage?',
